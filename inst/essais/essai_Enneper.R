...
# "[-3*u^2+3*v^2+z,
# 6*u*v^2-u*z+9*u-3*x,9*u*v*y-2*u*z^2+18*u*z-9*v^2*x-6*x*z,
# -4*u*v*z+3*u*y-3*v*x,-9*u*x-6*v^2*z+9*v*y-z^2+9*z,
# -27*u*y^2+8*u*z^3-72*u*z^2+36*v^2*x*z+27*v*x*y+24*x*z^2,
# -2*v^3-v*z-3*v+y,
...
f <- function(x, y, z) {
  -19683*x^6+59049*x^4*y^2-10935*x^4*z^3-118098*x^4*z^2+59049*x^4*z-
    59049*x^2*y^4-56862*x^2*y^2*z^3-118098*x^2*y^2*z-1296*x^2*z^6-
    34992*x^2*z^5-174960*x^2*z^4+314928*x^2*z^3+19683*y^6-
    10935*y^4*z^3+118098*y^4*z^2+59049*y^4*z+1296*y^2*z^6-34992*y^2*z^5+
    174960*y^2*z^4+314928*y^2*z^3+64*z^9-10368*z^7+419904*z^5
}

n <- 200L
x_ <- y_ <- z_ <- seq(-3, 3, length.out = n)
Grid <- expand.grid(X = x_, Y = y_, Z = z_)
voxel <- array(with(Grid, f(X, Y, Z)), dim = c(n, n, n))
library(rmarchingcubes)
surf <- contour3d(voxel, 0, x_, y_, z_)
library(rgl)
mesh <- tmesh3d(
